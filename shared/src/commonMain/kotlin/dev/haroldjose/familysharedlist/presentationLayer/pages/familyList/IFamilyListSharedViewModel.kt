...
enum class FamilyListSharePageTabEnum(val value: Int) {
    PRIORIZED(0) {
    ...
    companion object {
        fun getBy(value: Int): FamilyListSharePageTabEnum = entries.firstOrNull { it.value == value } ?: FamilyListSharePageTabEnum.PENDING
    }
}
...
interface IFamilyListSharedViewModel {
    ...
    var quantity: Int
    var tabIndex: FamilyListSharePageTabEnum

    suspend fun loadData(tabIndex: FamilyListSharePageTabEnum)
    suspend fun add()
